		...
		<div class="books" id="books">
			...
			<div id="topBar">
				<div id="containerLogo">
					<h1>
						<a href="http://localhost:8080/BookManagment/home">Book
							Management</a>
					</h1>
				</div>
			</div>
				...
				<form action="home" method="post">
					<div id="research">
						...
						<input name="searchbart" id="searchBoxTitle"
							...
							name="searchbara" id="searchBoxAuthor"
...
<div id="myModal" class="modal">
				...
				<div id="row">				
					...
					<div id="dettagliinserimento">
						<form action="home?action=modify&id=<%=bean.getId()%>" method="post">
...
<a href="home?action=delete&id=<%=bean.getId()%>">
...
<i class="fas fa-trash-alt" style="margin-auto"></i></span></a>
				...
				<span id="modify" class="modify" title="Modifica questo libro" onclick="mine(<%=i%>)"><i class="fas fa-pencil-alt"></i></span>
					...
					%>
							...
							<span id="add" class="add" onclick="insert()" title="Aggiungi un nuovo libro"><i class="fas fa-plus-circle"></i></span>
